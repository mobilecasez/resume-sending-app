...
with open('public/js/app-header.js', 'w') as f:
    f.write("""/**
...
<div class="mobile-menu" id="mobileMenu">
    ...
    <a href="/#why">Why CVApplyr <span>→</span></a>
    <a href="/#features">Features <span>→</span></a>
...
""")
print("app-header.js completely rewritten for new dashboard design sync!")
