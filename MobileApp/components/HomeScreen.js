        ...
        <View style={menuStyles.container}>
          ...
          <View style={menuStyles.panel}>
            ...
            {[
              ...
              { icon: 'stats-chart-outline', title: 'Push Analytics', sub: 'What happened to what we sent', onPress: () => { setShowSettings(false); require('expo-router').router?.push?.('/(admin)/push-analytics'); } },
