...
<p style="text-align:center;margin-bottom:9px">of <b>${esc(COMPANY)}</b>, entered in the Minutes Book and signed by the sole Director pursuant to Section 122(3) of the Companies Act, 2013, on ${rdate ? `<b>${esc(rdate)}</b>` : fill('', 130)} at the Registered Office of the Company.</p>

<p><b>1. Enabling payment acceptance on Google Play.</b> <b>RESOLVED THAT</b> the Company be and is hereby authorised to register with and avail the payment aggregation, collection and settlement services of BillDesk (IndiaIdeas.com Limited) for the purpose of accepting payments in respect of the Company&rsquo;s applications distributed on Google Play${appId ? `, in connection with Application ID <b>${esc(appId)}</b>` : ''}, and to accept and execute the applicable merchant agreements and policies.</p>

<p><b>2. Authorised person for Merchant Onboarding.</b> <b>RESOLVED FURTHER THAT ${who ? `Mr. ${esc(who)}` : '&nbsp;'}, ${esc(desig)}${din ? ` (DIN ${esc(din)})` : ''}, is the authorised person for Merchant Onboarding of BillDesk</b> on behalf of the Company; and that he be and is hereby authorised to sign, execute and submit, for and on behalf of the Company, all applications, agreements, undertakings, declarations and know-your-customer documents required in connection therewith; to attest copies of the Company&rsquo;s constitutional and statutory documents; and to do all such acts and things as may be necessary to give effect to this resolution.</p>

<p><b>3. Settlement account.</b> <b>RESOLVED FURTHER THAT</b> the said authorised signatory be and is hereby authorised to nominate and link the bank account of the Company${bankNamed ? ` bearing account number <b>${esc(B.accountNumber)}</b> maintained with <b>${esc(B.bankName)}</b>${B.ifsc ? ` (IFSC ${esc(B.ifsc)})` : ''}` : ''} for the receipt of settlement proceeds, and to give such instructions as may be required.</p>

<p><b>4. Validity and ratification.</b> <b>RESOLVED FURTHER THAT</b> this authority shall remain in force until expressly revoked by a further resolution of the Company, and all acts already done in furtherance hereof are hereby ratified and confirmed.</p>

<p><b>Certified to be a true copy</b> of the resolution entered in the Minutes Book of the Company.</p>
